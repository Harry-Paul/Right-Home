  ...
  return (
    <abc>
      <div className="mx-auto bg-root bg-no-repeat bg-cover bg-center bg-fixed">
        <div className="mx-auto flex justify-center bg-black opacity-75 lg:h-[70px] md:60px h-[50px]">
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-8 text-white lg:px-20 px-10 lg:py-[152px] py-[80px]">
